...
class AndroidBuilder {
  constructor() {
    ...
    this._engineAndroidDir = `${this._repoDir}/internal_folder/react-native-wix-engine/android`;
  }
  ...
  build(buildType) {
    ...
    execSync(`internal_folder/react-native-wix-engine/android/gradlew \
      -Duser.dir=${__dirname}/../../../../../internal_folder/react-native-wix-engine/android \
      app:assemble${config} \
      -DVERSION_CODE=1 \
      -DVERSION_NAME=999.999.999 \
    `, {stdio: 'inherit'});
    const destinationDir = `${this._repoDir}/internal_folder/react-native-wix-engine/app_builds/android/${buildType}`;
